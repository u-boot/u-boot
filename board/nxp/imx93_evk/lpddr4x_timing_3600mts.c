 ...
 * DDR PHY FW2022.01
 * Part number: NXP LPDDR4X EVK and FRDM 14x12 board's default DDR part
 */
...
static struct dram_fsp_cfg ddr_dram_fsp_cfg[] = {
    {
        {
            {0x4e300100, 0x24AA321B},
            {0x4e300104, 0xDAEE001A},
            {0x4e300108, 0x1C1E4222},
            {0x4e30010C, 0x0005E188},
            {0x4e300124, 0x1B030000},
            {0x4e300160, 0x0000B102},
            {0x4e30016C, 0x34F00000},
            {0x4e300170, 0x8B0B0608},
            {0x4e300250, 0x00000026},
            {0x4e300254, 0x014E014E},
            {0x4e300258, 0x00000008},
            {0x4e30025C, 0x00000400},
            {0x4e300300, 0x214C2113},
            {0x4e300304, 0x014E2212},
            {0x4e300308, 0x0A3C0D83},
        },
        {
            {0x01, 0xE4},
            {0x02, 0x36},
    ...
    {
        {
            {0x4e300100, 0x12542100},
            {0x4e300104, 0xDA77000D},
            {0x4e300108, 0x1616E499},
            {0x4e30010C, 0x005101E4},
            {0x4e300124, 0x0D830000},
            {0x4e300160, 0x0000B101},
            {0x4e30016C, 0x30900000},
            {0x4e300170, 0x8A0A0508},
            {0x4e300250, 0x00000013},
            {0x4e300254, 0x00A300A3},
            {0x4e300258, 0x00000008},
            {0x4e30025C, 0x00000400},
        },
        {
