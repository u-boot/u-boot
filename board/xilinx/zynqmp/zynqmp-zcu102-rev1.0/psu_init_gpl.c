...
/*##################################################################### */
    ...
    *  PSU_CRL_APB_RPLL_CTRL_FBDIV                                 0x59
    ...
    * PLL Basic Control
    * (OFFSET, MASK, VALUE)      (0XFF5E0030, 0x00717F00U ,0x00015900U)
    */
	PSU_Mask_Write(CRL_APB_RPLL_CTRL_OFFSET, 0x00717F00U, 0x00015900U);
/*##################################################################### */
...
/*##################################################################### */
    ...
    *  PSU_CRL_APB_RPLL_FRAC_CFG_DATA                              0x8e69

    * Fractional control for the PLL
    * (OFFSET, MASK, VALUE)      (0XFF5E0038, 0x8000FFFFU ,0x80008E69U)
    */
	PSU_Mask_Write(CRL_APB_RPLL_FRAC_CFG_OFFSET,
		0x8000FFFFU, 0x80008E69U);
/*##################################################################### */
...
/*##################################################################### */
    ...
    */
	PSU_Mask_Write(CRF_APB_VPLL_CTRL_OFFSET, 0x00717F00U, 0x00015900U);
/*##################################################################### */
...
/*##################################################################### */
    ...
    * 6 bit divider
    *  PSU_CRL_APB_PL3_REF_CTRL_DIVISOR0                           0xf
    ...
    * This register controls this reference clock
    * (OFFSET, MASK, VALUE)      (0XFF5E00CC, 0x013F3F07U ,0x01010F00U)
    */
...
/*##################################################################### */
    ...
    * 6 bit divider
    *  PSU_CRF_APB_DP_AUDIO_REF_CTRL_DIVISOR0                      0x3c
    ...
    * This register controls this reference clock
    * (OFFSET, MASK, VALUE)      (0XFD1A0074, 0x013F3F07U ,0x01013C03U)
    */
	PSU_Mask_Write(CRF_APB_DP_AUDIO_REF_CTRL_OFFSET,
		0x013F3F07U, 0x01013C03U);
/*##################################################################### */
    ...
    * 6 bit divider
    *  PSU_CRF_APB_DP_STC_REF_CTRL_DIVISOR0                        0x38
    ...
    * This register controls this reference clock
    * (OFFSET, MASK, VALUE)      (0XFD1A007C, 0x013F3F07U ,0x01013803U)
    */
	PSU_Mask_Write(CRF_APB_DP_STC_REF_CTRL_OFFSET,
		0x013F3F07U, 0x01013803U);
/*##################################################################### */
...
/*##################################################################### */
    ...
    * PLL Gear Shift Time
    *  PSU_DDR_PHY_PTR0_TPLLGS                                     0x2158

    * PHY Reset Time
    *  PSU_DDR_PHY_PTR0_TPHYRST                                    0x10

    * PHY Timing Register 0
    * (OFFSET, MASK, VALUE)      (0XFD080040, 0xFFFFFFFFU ,0x0AC85610U)
    */
	PSU_Mask_Write(DDR_PHY_PTR0_OFFSET, 0xFFFFFFFFU, 0x0AC85610U);
/*##################################################################### */
    ...
    */
	PSU_Mask_Write(DDR_PHY_PTR1_OFFSET, 0xFFFFFFFFU, 0x41980B06U);
/*##################################################################### */
...
/*##################################################################### */
    ...
    */
	PSU_Mask_Write(DDR_PHY_DTPR1_OFFSET, 0xFFFFFFFFU, 0x28210008U);
/*##################################################################### */
...
/*##################################################################### */
    ...
    */
	PSU_Mask_Write(DDR_PHY_DTPR5_OFFSET, 0xFFFFFFFFU, 0x00330F09U);
/*##################################################################### */
...
/*##################################################################### */
    ...
    *  PSU_IOU_SLCR_SD_CONFIG_REG1_SD1_BASECLK                     0xbb

    * Configures the Number of Taps (Phases) of the rxclk_in that is supported
    * .
    *  PSU_IOU_SLCR_SD_CONFIG_REG1_SD1_TUNIGCOUNT                  28

    * SD Config Register 1
    * (OFFSET, MASK, VALUE)      (0XFF18031C, 0x7FFE0000U ,0x5DB80000U)
    */
	PSU_Mask_Write(IOU_SLCR_SD_CONFIG_REG1_OFFSET,
		0x7FFE0000U, 0x5DB80000U);
/*##################################################################### */
...
/*##################################################################### */
    ...
    * PHY Mode: 4'b000 - PCIe, 4'b001 - USB3, 4'b0010 - SATA, 4'b0100 - SGMII,
    *  4'b0101 - DP, 4'b1000 - MPHY
    *  PSU_SERDES_L3_TXPMA_ST_0_TX_PHY_MODE                        0x21

    * Opmode Info
    * (OFFSET, MASK, VALUE)      (0XFD40CB00, 0x000000F0U ,0x000000F0U)
    */
	PSU_Mask_Write(SERDES_L3_TXPMA_ST_0_OFFSET,
		0x000000F0U, 0x000000F0U);
/*##################################################################### */
