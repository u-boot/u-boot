...
The em100 tool is available here: https://review.coreboot.org/admin/repos/em100,general
...
https://www.dediprog.com/product/EM-TC-8.
...
refer to :download:`intel,irq-router.txt <../../device-tree-bindings/misc/intel,irq-router.txt>` for
