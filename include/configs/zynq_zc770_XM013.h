...
/* Board: ZC770 with DC4 */
#define CONFIG_ZC770_XM013
...
#define CONFIG_SYS_PBSIZE		(CONFIG_SYS_CBSIZE+ \
			sizeof(CONFIG_SYS_PROMPT)+16) /* phycore */
