 ...
 * The active_pcr is only valid for TPMv2 after the device is initialized
 *
 ...
 * @active_pcr_count:	Number of active PCR banks
 * @active_pcr:		Array of active PCRs
...
struct tpm_chip_priv {
	...
	u8 active_pcr_count;
	u32 active_pcr[TPM2_NUM_PCR_BANKS];
#endif
