					  ...
					  struct public_key_signature **sig)
{
	...
	/*
	 * Optional attributes:
	 * auth_ids holds AuthorityKeyIdentifier (infomation of issuer), aka akid,
	 * which is used to match with a cert's id or skid to indicate that is
	 * the issuer when we lookup a cert chain.
	 *
	 * auth_ids[0]:
