...
static int mock_read(struct udevice *dev, loff_t src, ulong size,
		     void *dst)
{
	struct mock_priv *p = dev_get_priv(dev);
...
static const struct imagemap_ops mock_ops = {
	.read	= mock_read,
};
...
IMG_LOADER_TEST(imagemap_test_map_basic, 0);
...
IMG_LOADER_TEST(imagemap_test_map_cached, 0);
...
IMG_LOADER_TEST(imagemap_test_map_offset, 0);
...
IMG_LOADER_TEST(imagemap_test_map_extend, 0);
...
IMG_LOADER_TEST(imagemap_test_map_to, 0);
...
IMG_LOADER_TEST(imagemap_test_lookup_miss, 0);
...
IMG_LOADER_TEST(imagemap_test_lmb_reserve, 0);
...
IMG_LOADER_TEST(imagemap_test_cleanup, 0);
...
IMG_LOADER_TEST(imagemap_test_multi_region, 0);
...
IMG_LOADER_TEST(imagemap_test_read_oob, 0);
