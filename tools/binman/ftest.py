...
'  fdtmap           90   243  fdtmap          90',
    ...
    def testCapsuleGen(self):
        ...
        input_fname = TestFunctional._MakeInputFile('payload.txt', self.payload_data)
        print('payload.txt path =>' + input_fname)
    ...
    def testCapsuleGenImplicitCapsuleName(self):
        ...
        # Image GUID specified in the DTS
        self.image_guid = "52cfd7092007104791d108469b7fe9c8"
        self.capsule_fname = 'payload.capsule'
