...
'  fdtmap           90   243  fdtmap          90',
    ...
    def testCapsuleGen(self):
        ...
        self._DoReadFile('290_capsule.dts')
    ...
    def testSignedCapsuleGen(self):
        ...
        self._DoReadFile('291_capsule_signed.dts')
    ...
    def testCapsuleGenVersionSupport(self):
        ...
        self._DoReadFile('297_capsule_version.dts')
    ...
    def testCapsuleGenKeyMissing(self):
        ...
        with self.assertRaises(ValueError) as e:
            self._DoReadFile('292_capsule_missing_key.dts')
    ...
    def testCapsuleGenIndexMissing(self):
        ...
        with self.assertRaises(ValueError) as e:
            self._DoReadFile('293_capsule_missing_index.dts')
    ...
    def testCapsuleGenGuidMissing(self):
        ...
        with self.assertRaises(ValueError) as e:
            self._DoReadFile('294_capsule_missing_guid.dts')
    ...
    def testCapsuleGenPayloadMissing(self):
        ...
        with self.assertRaises(ValueError) as e:
            self._DoReadFile('295_capsule_missing_payload.dts')
    ...
    def testCapsuleGenCapsuleFileMissing(self):
        ...
        with self.assertRaises(ValueError) as e:
            self._DoReadFile('296_capsule_missing.dts')
